...
/**
 * Typed.js strings — defined at module scope to avoid recreation on each render.
 * @type {string[]}
 */
const TYPED_STRINGS = [
	'Fullstack',
...
/**
 * Brief intro slide — first section of the portfolio.
 * Displays a profile photo and an animated typing effect via Typed.js.
 *
 * @returns {JSX.Element}
 */
const Brief = () => {
